...
export const AppText = ({
  ...
  return React.createElement(
    Text,
    { numberOfLines: N_LINE, style: applyCommonStyles(rest), ...rest },
    children
  );
};
export const AppView = ({
  ...
  return React.createElement(
    TouchableOpacity,
    { style: [applyCommonStyles(rest)], ...rest },
    children
  );
};
...
export const FlexView = ({ children, ...props }) => {
  return React.createElement(
    View,
    { style: [{ flex: 1 }, applyCommonStyles(props)], ...props },
    children
  );
};
